namespace OrderProcessing
{
    ...
    public partial class ModifyOrderForm : Form
    {
        ...
        {
            customerldComboBox.Text = "Select Customr ld";
        ...
        private void GetOrderDetails()
        {
            ...
            else
            {
                ...
                {
                    total += AddToListViewFromDatBase(dvOrderDetails, cntltems);
        ...
        {
            lvProducts = new DataView(northwindDataSet.SalesOrderDetails);
            lvProducts.RowFilter = "Orderld=" + OrderIdComboBox.Text + "ANDProductId=" +
            lvProducts.FocusedItem.SubItems[0].Text;
            if (lvProducts.Count == 0)
            {
